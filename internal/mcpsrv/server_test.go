...
func TestBrokerServerRegistersSharedTools(t *testing.T) {
	...
	want := map[string]bool{"rdev_sync": false, "rdev_secrets": false, "rdev_broker_pool": false, "rdev_broker_status": false, "rdev_list": false, "rdev_ping": false, "rdev_exec": false, "rdev_read": false, "rdev_write": false, "rdev_edit": false, "rdev_edit_preview": false, "rdev_edit_rollback": false, "rdev_operation_status": false, "rdev_git_status": false, "rdev_systemd": false, "rdev_port_check": false, "rdev_capability": false, "rdev_job_start": false, "rdev_job_list": false, "rdev_job_status": false, "rdev_job_logs": false, "rdev_job_stop": false, "rdev_job_rm": false, "rdev_job_wait": false, "rdev_mutation_status": false, "rdev_job_events": false}
...
func TestAllToolsAreRegistered(t *testing.T) {
	...
	want := []string{
		...
		"rdev_read", "rdev_write", "rdev_edit", "rdev_edit_preview", "rdev_edit_rollback", "rdev_operation_status", "rdev_git_status", "rdev_systemd", "rdev_port_check", "rdev_list",
